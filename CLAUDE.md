...
- La tanda fue de PANTALLAZOS o mixta. Cada imagen pesa ~2.000 tokens y
  se re-envía en cada turno del resto del día.
- Ya se explicaron 2-3 tandas de TEXTO en esta sesión.
- Se cerró un capítulo y lo que sigue es otra cosa.
...
- Se cerró un capítulo o un bloque grande del libro.
- Se graduó un ejercicio (r3 bien): el examen confirma que el concepto
  se sostiene FUERA del ejercicio donde se aprendió.
