...
- PRÓXIMA SESIÓN: `/rename java-s104` (sale SIEMPRE de esta línea, NO se calcula: es un contador distinto al de las tandas. La última fue java-s103: repaso "compilador vs. JVM" r1, sin tanda. Antes: java-s102, triage + repaso de sobrescritura.)
