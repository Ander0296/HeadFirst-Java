# REPASO r1 ter — LIBRO: prep code para SimpleStartupGame — pág. 353-354, Sesión #64

Repaso desde cero. NO mires tus versiones anteriores ni la solución del libro.

Si te trabás: revisá la **Sesión #64 de GUIA-JAVA.md** (si ya está
archivada, está en GUIA-ARCHIVO.md).
Checklist: **ToDo/un-bucle-que-termina.md** — recorrelo MIENTRAS
escribís, no después.
...
<!-- Escribí acá tu prep code, línea por línea, desde cero. -->
...
```
/entrega Hice el REPASO r1 ter del ejercicio del libro "prep code para
SimpleStartupGame" (pág. 353-354). Mi respuesta está en
ejercicios/repasos/lib14-r1ter.md. Corregilo EN EL CHAT comparándolo
con mis versiones anteriores, y decime qué mejoré y qué error repetí.
```
